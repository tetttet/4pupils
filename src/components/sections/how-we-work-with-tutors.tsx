...
const items: CardItem[] = [
  {
    ...
    text: "Мы проверяем корректность заполнения профиля, соответствие описания правилам сервиса и отсутствие вводящей в заблуждение информации.",
  },
  {
    title: "Собираем отзывы учеников",
    text: "Мы отслеживаем качество занятий по реальным отзывам учеников и учитываем их опыт при дальнейшем продвижении анкеты.",
  },
  {
    title: "Регулярно обновляем базу",
    text: "Оставляем лучших, добавляем новых — чтобы вы могли быстро найти репетитора, которому действительно можно доверять.",
  },
  {
    title: "Снимаем анкету с публикации",
    text: "Если ученики сталкиваются с неэтичным, непрофессиональным поведением или нарушением стандартов сервиса.",
  },
];
          ...
          >
            <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
              ...
              <h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">
                Как мы работаем с репетиторами
              </h2>

              <p className="mt-5 max-w-2xl text-sm leading-7 text-white/85 md:text-base">
                Мы выстраиваем прозрачную систему проверки и поддержки качества,
                чтобы ученики находили преподавателей с уверенностью и без
                лишнего риска.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <div className="relative">
                  <ButtonSend className="px-10! py-4! text-[15px]! shadow-[0_18px_40px_rgba(255,255,255,0.16)]" />
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
