...
const CoursesFooter = () => {
  ...
  return (
    <footer className="w-full bg-[#f0f0f0] text-[#2f2f2f] pb-0">
        ...
        <div className="grid grid-cols-1 gap-20 md:grid-cols-2">
          <div className="max-w-180">
            ...
            <div className="mt-10 max-w-160 space-y-8 text-[14px] leading-[1.35] text-[#444444] select-none">
              <p>
                {brand.name} — это образовательная платформа для осознанного и
                системного обучения. Мы помогаем выстраивать индивидуальные
                маршруты, осваивать новые навыки в удобном темпе и возвращаться
                к материалам тогда, когда это действительно необходимо для
                закрепления и роста. Все элементы платформы — от гайдов до
                каталога курсов — объединены в единую, понятную систему.
              </p>

              <p>
                Платформа создана для студентов, преподавателей, авторов курсов
                и образовательных команд, которым важны структура, гибкость и
                качество. 4Pupils объединяет обучение, практику и развитие в
                одном пространстве и сопровождает пользователя на каждом этапе —
                от выбора направления до уверенного движения к результату.
              </p>

              <p>
                {`© 2026 ${brand.name}. Все права защищены.`}
              </p>
            </div>
          </div>
